...
const responses = {
  ...
  email: `For email issues, contact Apex: 
  ...
  hardware: `Contact Internal IT or submit a ticket: <br> (Internal: Angel/Derrick), 
        <a href="mailto:achaple@rbacharlotte.com" class="text-blue-600 underline">Angel Chaple</a> <br>
        Submit tickets to Apex: 
          <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
          <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,

  network: `For network issues, contact Apex: 
          <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
          <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,

  other: `For all other issues, contact Apex: 
          <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
          <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,
};

const softwareSupport = {
  "ms-365-apps": `For MS365 Issues, contact Apex: 
        <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
        <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,
...
const passwordSupport = {
  "windows-login": `For Windows Login Issues, contact Apex: 
          <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
          <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,

  "ms365-login": `For MS365 Login Issues, contact Apex: 
          <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
          <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,
  ...
  "ensemble-password": `For Ensemble password issues, contact fetch: 
          <a href="tel:18887228610" class="text-blue-600 underline">1-888-722-8610</a> or visit 
          <a href="https://andersenprod.service-now.com/csm" target="_blank" class="text-blue-600 underline">ServiceNow Portal</a>`,

  "culture-suite-password": `For CultureSuite Login Issues, contact Apex: 
          <a href="tel:18887228610" class="text-blue-600 underline">704-895-0010</a> option 7 / 
          <a href="https://rba.myportallogin.com/" target="_blank" class="text-blue-600 underline">ApexManage360 Portal</a>`,

  "rforce-password": `For rForce/rSuite password issues, contact fetch: 
          <a href="tel:18887228610" class="text-blue-600 underline">1-888-722-8610</a> or visit 
          <a href="https://andersenprod.service-now.com/csm" target="_blank" class="text-blue-600 underline">ServiceNow Portal</a>`,
};
